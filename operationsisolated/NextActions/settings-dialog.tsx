...
export function NextActionsSettingsDialog({ open, onClose }: NextActionsSettingsDialogProps) {
  ...
  const exportData = () => {
    ...
    link.href = url
    link.download = `next-actions-backup-${new Date().toISOString().split("T")[0]}.json`
    document.body.appendChild(link)
    link.click()
    document.body.removeChild(link)
    URL.revokeObjectURL(url)

    setImportStatus(`✅ Exported ${categories.length} categories and ${tasks.length} tasks successfully!`)
  ...
  const handleImportChoice = (mode: "add" | "replace") => {
    ...
    if (mode === "replace") {
      ...
      setImportStatus(
        `✅ Successfully imported ${pendingImport.categories.length} categories and ${pendingImport.tasks.length} tasks! (Replaced)`
      )
    } else {
      ...
      setImportStatus(
        `✅ Successfully imported ${pendingImport.categories.length} categories and ${pendingImport.tasks.length} tasks! (Added)`
      )
    }
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-2xl max-h-[80vh] overflow-hidden flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>Manage your categories and import/export your data.</DialogDescription>
        </DialogHeader>
          ...
          <TabsContent value="categories" className="flex-1 overflow-hidden">
            <div className="space-y-4 h-full">
              <div className="text-sm text-muted-foreground">
                Drag and drop to reorder categories. Click the trash icon to delete a category.
              </div>
            ...
            <div className="space-y-6 h-full">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Download all your categories and tasks as a JSON file for backup or transfer.
                </p>
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Import categories and tasks from a previously exported JSON file. This will let you choose whether to add or replace your current data.
                </p>
                ...
                <ChoiceDialogContent>
                  <ChoiceDialogHeader>
                    ...
                    <ChoiceDialogDescription>
                      You can <b>add</b> the imported categories and tasks to your existing data (no duplicates by ID), or <b>replace</b> all current categories and tasks with the imported data.
                    </ChoiceDialogDescription>
                  </ChoiceDialogHeader>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-sm">
                    ...
                    <div className="text-yellow-700">
                      Importing data will replace all current categories and tasks. Make sure to export your current
              ...
              <div className="pt-2">
                <Button
                  ...
                  className="w-full"
                  onClick={() => {
                    if (confirm("Are you sure you want to clear ALL categories and tasks? This cannot be undone.")) {
                      clearAllData()
