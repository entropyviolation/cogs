/**
 * electron/telegram-file.js — Download Telegram photo / PDF bytes for ingest
 */
...
async function hydrateTelegramUpdate(update, token, telegramApi) {
...
module.exports = { extractTelegramMessage, hydrateTelegramUpdate }
