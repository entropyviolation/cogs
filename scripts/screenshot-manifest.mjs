...
export const SHOTS = [
  ...
  },
  {
    ...
    description: `Multi-line capture; list: / folder: list: headers; optional Inbox; shorthand help.`,
  },
  {
    ...
    description: `Single-line capture with colon paths (folder: list: item), live destination chips, optional skip Inbox, and shorthand help.`,
  },
  {
